...
import CA_VIDEO from "../../assets/projects/videos/ca_video.mp4";

export const IG_LINK = "https://www.instagram.com/boubous0917/";
export const GITHUB_LINK = "https://github.com/boubous0917";
export const LINKEDIN_LINK =
  "https://www.linkedin.com/in/%E6%9F%8F%E9%BE%8D-%E6%9B%BE-782865324/";

export const HERO_CONTENT =
  "我是一位前端工程師，畢業於私立世新大學資管系，目前已經有 1 年的設計及開發經驗，我熱衷於前端工程的開發以及設計，並多方面操作及使用不同框架以及開發模式，利用UI的優化及互動性促使使用者體驗起來更加有趣及實用。";
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    technologies: ["Flutter", "Firebase", "Restful API", "Git", "Flask"],
  },
];
